      ...
      {isSpecialist && ticket.lastAssignment?.status === "REJECTED" && (
        ...
        >
          ...
          <Text fontSize="xs" color="red.500" mt={1}>
            {ticket.lastAssignment.toUser?.fio ||
              ticket.lastAssignment.toUser?.username ||
              "—"}{" "}
          ...
          <InfoRow label="Категория по мнению поддержки">
            {isSpecialist ? (
              <DataSelect
                ...
                value={
                  ticket.categorySupport
                    ? [ticket.categorySupport.id.toString()]
                    : undefined
                }
                onValueChange={(e) => {
