...
import {Box, Button, Heading, HStack, Icon, Separator, Switch, Text, VStack,} from "@chakra-ui/react";
import {LuBell, LuSave, LuTicket, LuUserCheck,} from "react-icons/lu";
...
export function NotificationSettingsCard({
    ...
    const handleToggle = (type: NotificationType, channel: "inAppEnabled" | "vkEnabled" | "maxEnabled") => {
    ...
    const handleToggleAllColumn = (channel: "inAppEnabled" | "vkEnabled" | "maxEnabled") => {
    ...
    return (
        ...
        >
            ...
            <HStack
                ...
                mb={2}
            >
                <Text flex={1} fontSize="xs" fontWeight="semibold" color="fg.muted" textTransform="uppercase"
                      letterSpacing="wide">
                    Тип уведомления
                </Text>
                ...
                <HStack w="100px" justify="center" gap={2}>
                    ...
                    <Switch.Root
                        size="sm"
                        colorPalette="blue"
                        checked={settings.every((s) => s.vkEnabled)}
                        onCheckedChange={() => handleToggleAllColumn("vkEnabled")}
                    >
                        <Switch.HiddenInput/>
                        <Switch.Control>
                            <Switch.Thumb/>
                ...
                <HStack w="100px" justify="center" gap={2}>
                    ...
                    <Switch.Root
                        size="sm"
                        colorPalette="blue"
                        checked={settings.every((s) => s.maxEnabled)}
                        onCheckedChange={() => handleToggleAllColumn("maxEnabled")}
                    >
                        <Switch.HiddenInput/>
                        <Switch.Control>
                            <Switch.Thumb/>
                            ...
                            {group.types.map(({type, label}) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <Box w="100px" display="flex" justifyContent="center">
                                            <Switch.Root
                                                checked={setting.vkEnabled}
                                                onCheckedChange={() =>
                                                    handleToggle(type, "vkEnabled")
                                                }
                                            >
                                                <Switch.HiddenInput/>
                                                <Switch.Control>
