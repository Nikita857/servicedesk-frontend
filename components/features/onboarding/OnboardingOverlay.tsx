...
export const USER_ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    title: "База знаний",
    description:
      "Здесь собраны статьи и инструкции по частым вопросам. Это может помочь решить проблему без создания заявки.",
    placement: "right",
  },
  {
    ...
    title: "Уведомления",
    description:
      "Здесь появятся оповещения об изменении статуса ваших заявок, новых сообщениях от специалистов и других событиях.",
    placement: "bottom",
  },
  {
    ...
    description:
      "Управляйте своим аккаунтом: смените аватар, просмотрите свои данные или выйдите из системы.",
...
export const WIKI_ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    description:
      "Сортирует статьи по группам. Если у вас в личном кабинете указан отдел, вы можете отсортировать статьи по отделу. Если нет — вы видите все статьи.",
    placement: "bottom",
  },
  {
    ...
    title: "Поиск",
    description:
      "Полнотекстовый поиск по названию и содержимому статьи. Может предлагать подсказки при наборе текста.",
    placement: "bottom",
  },
  {
    targetId: "wiki-tree",
    title: "Дерево статей",
    description:
      "Иерархическая структура статей по категориям.",
    placement: "bottom",
  },
];
...
export const TICKET_FORM_ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    description:
      "Выбирайте приоритет осознанно: если проблема не критичная, не стоит устанавливать приоритет «Срочный».",
    placement: "bottom",
  },
  {
    targetId: "t-category",
    title: "Выбор категории проблемы",
    description:
  ...
  {
    targetId: "t-line",
    title: "Выбор линии поддержки",
    description:
      "Здесь выбирается, кому будет направлено ваше обращение. При выборе категории значение устанавливается автоматически, но при желании вы можете изменить его.",
    placement: "right",
  },
  {
    ...
    title: "Описание",
    description:
      "Здесь вам нужно подробно описать свою проблему, чтобы специалисты поддержки поняли её суть и помогли решить её.",
    placement: "right",
  },
];
