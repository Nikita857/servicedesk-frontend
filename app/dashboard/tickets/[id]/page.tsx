...
import {Box, Button, Collapsible, Flex, Grid, GridItem, HStack, Spinner, Status, Text, Wrap,} from "@chakra-ui/react";
...
import {useEscalation, useSupportLinesQuery, useTicketQuery, useTicketWebSocket,} from "@/lib/hooks";
import {useCoExecutors} from "@/lib/hooks/ticket-detail/useCoExecutors";
import {ClosureConfirmationDialog, TicketChat,} from "@/components/features/tickets";
                                    ...
                                    <Wrap gap={2}>
                                        <HStack>
                                            <Tooltip content="Статус заявки">
                                                <Status.Root>
                                                    <Status.Indicator colorPalette={statusConf.color}/> <Text
                                                    fontWeight="medium" fontSize="sm">{statusConf.label}</Text>
                                                </Status.Root>
                                            </Tooltip>
                                            <Tooltip content="Приоритет">
                                                <Status.Root>
                                                    <Status.Indicator colorPalette={priorityConf.color}/> <Text
                                                    fontWeight="medium" fontSize="sm">{priorityConf.label}</Text>
                                                </Status.Root>
                                            </Tooltip>
                                        </HStack>
